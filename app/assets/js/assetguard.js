...
const LoggerUtil = require('./loggerutil.min')
const ConfigManager = require('./configmanager.min')
const DistroManager = require('./distromanager.min')
const isDev = require('./isdev.min')
    ...
    validateLogConfig(versionData) {
        ...
        return new Promise((resolve) => {
            ...
            if (!AssetGuard._validateLocal(logConfig.to, 'sha1', logConfig.hash)) {
                ...
                self.files.dlsize += logConfig.size
                resolve()
            } else {
                resolve()
            }
...
*/
     ...
     */
    processDlQueues(identifiers = [{id: 'assets', limit: 20}, {id: 'libraries', limit: 5}, {
        id: 'files',
        limit: 5
    }, {id: 'forge', limit: 5}]) {
        return new Promise((resolve) => {
